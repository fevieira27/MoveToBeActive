...
class AnalogView extends WatchUi.WatchFace
{
    ...
    function initialize() {
        ...
        if (Storage.getValue(23)==null or Storage.getValue(23)<currentVersion){ // only runs at first install or watch face update
            ...
            if (Storage.getValue(15) == null or Storage.getValue(15) == true){ Storage.setValue(15, 0); } else if(Storage.getValue(15) == false) { Storage.setValue(15, 1); }  // Wind Unit
            ...
            Storage.deleteValue(21); // temporary removal of "checks" array, until a new variable is needed
        }
    }
